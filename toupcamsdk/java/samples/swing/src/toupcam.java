...
public class toupcam implements AutoCloseable {
    ...
    public final static int OPTION_FRONTEND_DEQUE_LENGTH  = 0x31;       /* frontend (raw) frame buffer deque length, range: [2, 1024], default: 4
                                                                        ...
                                                                        */
    public final static int OPTION_FRAME_DEQUE_LENGTH     = 0x31;       /* alias of TOUPCAM_OPTION_FRONTEND_DEQUE_LENGTH */
    ...
    public static String PixelFormatName(int val) {
        return _lib.Toupcam_get_PixelFormatName(val);
    }
    ...
    private interface CLib {
        ...
        int Toupcam_PullImageV3(Pointer h, Pointer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Toupcam_WaitImageV3(Pointer h, int nWaitMS, Pointer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        ...
        int Toupcam_TriggerSync(Pointer h, int nTimeout, Pointer pImageData, int bits, int rowPitch, FrameInfoV3 pInfo);
        ...
        int Toupcam_get_PixelFormatSupport(Pointer h, byte cmd, IntByReference iValue);
        ...
        int Toupcam_IoControl(Pointer h, int ioLineNumber, int eType, int outVal, IntByReference inVal);
        ...
        int Toupcam_TriggerSyncArray(Pointer h, int nTimeout, byte[] pImageData, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Toupcam_PullImageV3Array(Pointer h, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Toupcam_WaitImageV3Array(Pointer h, int nWaitMS, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
    ...
    */
    ...
    /* get the version of this dll/so/dylib, which is: 55.24446.20240114 */
    ...
    */
    public void TriggerSync(int nTimeout, ByteBuffer pImageData, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Toupcam_TriggerSync(_handle, nTimeout, Native.getDirectBufferPointer(pImageData), bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void TriggerSync(int nTimeout, byte[] pImageData, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        errCheck(_lib.Toupcam_TriggerSyncArray(_handle, nTimeout, pImageData, bits, rowPitch, pInfo));
    }
    ...
    */
    ...
    public int IoControl(int ioLineNumber, int eType, int outVal) throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Toupcam_IoControl(_handle, ioLineNumber, eType, outVal, p));
        return p.getValue();
    }
    ...
    public void get_FocusMotor(FocusMotor pFocusMotor) throws HRESULTException {
