...
internal class Toupcam : IDisposable
{
    ...
    public enum eEVENT : uint
    {
        ...
        EVENT_FPNC               = 0x000f, /* fix pattern noise correction status changed */
    ...
    public enum eOPTION : uint
    {
        ...
        OPTION_AFMODE                 = 0x25,       /* auto focus mode, see AFMode */
        OPTION_AFSTATUS               = 0x27,       /* auto focus status, see AFStaus */
        ...
        OPTION_CALLBACK_THREAD        = 0x30,       /* dedicated thread for callback: 0 => disable, 1 => enable, default: 0 */
        ...
        OPTION_FPNC                   = 0x67         /* Fix Pattern Noise Correction
                                                             set:
                                                                 0: disable
                                                                 1: enable
                                                                -1: reset
    ...
    /* get the version of this dll/so, which is: 55.24446.20240114 */
