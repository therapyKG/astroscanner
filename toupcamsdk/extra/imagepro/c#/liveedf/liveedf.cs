...
internal class Liveedf : IDisposable
{
    ...
    public void Pull(Toupcam.SafeCamHandle hToupcam, int bFeed, IntPtr pImageData, int bits, int rowPitch, out Toupcam.FrameInfoV2 pInfo)
    {
        imagepro_edf_pull(handle_, hToupcam, bFeed, pImageData, bits, rowPitch, out pInfo);
    }

    public void PullV3(Toupcam.SafeCamHandle hToupcam, int bFeed, IntPtr pImageData, int bits, int rowPitch, out Toupcam.FrameInfoV3 pInfo)
    {
        imagepro_edf_pullV3(handle_, hToupcam, bFeed, pImageData, bits, rowPitch, out pInfo);
    }
    ...
    */
    ...
    [DllImport("imagepro.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
    private static extern void imagepro_edf_pull(SafeLiveedfHandle handle, Toupcam.SafeCamHandle hToupcam, int bFeed, IntPtr pImageData, int bits, int rowPitch, out Toupcam.FrameInfoV2 pInfo);
    [DllImport("imagepro.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
    private static extern void imagepro_edf_pullV3(SafeLiveedfHandle handle, Toupcam.SafeCamHandle hToupcam, int bFeed, IntPtr pImageData, int bits, int rowPitch, out Toupcam.FrameInfoV3 pInfo);
}